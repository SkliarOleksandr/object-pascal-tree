...
uses
  ...
  PasTreeDemo.UnitPicker in 'PasTreeDemo.UnitPicker.pas' {frmUnitPicker},
  PasTreeDemo.GoToPicker in 'PasTreeDemo.GoToPicker.pas' {frmGoTo},
  PasTreeDemo.Coverage in 'PasTreeDemo.Coverage.pas',
