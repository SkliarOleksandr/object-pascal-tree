...
Гарантия инварианта sec. 1.5: intf-снапшот вообще никогда не трогается; full-снапшот -
...
1. НОВЫЙ StagedParseSmoke (или в ParserSmoke): (a) intf-дерево == префикс
   full-дерева (memcmp с оговорками sec. 2.2); (b) full-дерево при перепарсе ==
...
(FPP.Process заново - против sec. 2.2; исправлено: парс из Tree.Source intf-
...
- Model id недетерминированы в async (sec. 2.4) - дампы сортировать, ни на что другое
  не влияет.
