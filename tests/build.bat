...
set SUITES=ParserSmoke ResilienceSmoke StagedParseSmoke DProjSmoke SemaSmoke SemaTypeSmoke SemaXTypeSmoke SemaOverloadSmoke SemaProjectSmoke SemaNavSmoke SemaCompleteSmoke AsyncSmoke UnitListSmoke NavHistorySmoke DemoSettingsSmoke
